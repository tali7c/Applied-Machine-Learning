  ...
  \begin{columns}[T]
    \begin{column}{0.49\textwidth}
      \begin{block}{How it is structured}
        Of the 15 project marks, \textbf{10 are individual} --- a written
        paper on your own group's project, one set per theme, with every
        member sitting it separately --- and \textbf{5 are for the group},
        identical for every member, awarded for the state \emph{and the
        commit history} of the submitted repository.
      \end{block}
    \end{column}
    \begin{column}{0.49\textwidth}
