...
\emph{then} check it against the answers.

The answers are in \texttt{A1-Bank-Answers.pdf}, in this folder --- all 314 of
them, with full working for every numerical. Open them \emph{after} you have
worked the question, not instead of working it.
\end{warnbox}
